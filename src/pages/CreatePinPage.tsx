    ...
    return (
        <MobileLayout>
            <div className="flex flex-col h-full w-full px-6 font-inter pb-[165px]">
                {/* Botão de voltar */}
                <button
                    className="mt-[68px] mb-[72px] self-start"
                ...
                {/* PIN container com bolinhas */}
                <div className="mt-[120px] mx-auto w-[299px] h-[48px] border border-white/60 rounded-full flex items-center justify-center gap-[20px] relative">
                    {[0, 1, 2, 3].map((index) => (
                        <div
                            key={index}
